...
Item {
    ...
    Image {
                id: gifBackground
                source: "" // Set the path to your GIF file
                anchors.fill: parent
    }
    Timer {
        id: questionTimer
    ...
    function shuffleQuestionsModel() {
        ...
        var allQuestions = [
                            ...
                            {
                                question: "If a shirt costs $20 after \n a 25% discount, what was its original\n price?",
                                option1: "$15",
                                option2: "$25",
                                option3: "$30",
                                option4: "$40",
                            ...
                            {
                                question: "If 3 cats can catch 3 mice \nin 3 minutes, how many cats are needed to \ncatch 100 mice in 100 minutes?",
                                option1: "1",
                                option2: "3",
                                option3: "100",
                                option4: "300",
                            ...
                            {
                                    question: "If 3 apples cost $1, how many \napples can you buy for $5?",
                                    option1: "5 apples",
                                    option2: "10 apples",
                                    option3: "15 apples",
                                    option4: "20 apples",
                                ...
                                {
                                    question: "A book costs $12, and a pen costs\n $2. How much do you spend \non 3 books and 4 pens?",
                                    option1: "$36",
                                    option2: "$24",
                                    option3: "$50",
                                    option4: "$30",
                                ...
                                {
                                    question: "If 2/3 of a number is 8, \nwhat is the number?",
                                    option1: "6",
                                    option2: "9",
                                    option3: "12",
                                    option4: "16",
                                ...
                                {
                                    question: "If it takes 5 workers 6 hours\n to build a wall, how many hours will \nit take 3 workers to build the same wall?",
                                    option1: "8 hours",
                                    option2: "10 hours",
                                    option3: "12 hours",
                                    option4: "15 hours",
                                ...
                                {
                                    question: "If the day after tomorrow is two \ndays before Wednesday, \nwhat day is it today?",
                                    option1: "Sunday",
                                    option2: "Monday",
                                    option3: "Tuesday",
                                    option4: "Thursday",
                                ...
                                {
                                    question: "A car travels 360 miles in 6 hours.\n What is its average speed \nin miles per hour?",
                                    option1: "40 mph",
                                    option2: "50 mph",
                                    option3: "60 mph",
                                    option4: "70 mph",
                                ...
                                {
                                    question: "If a recipe calls for 2/3 cup \nof sugar and you want to make \nhalf the recipe, how much sugar do you need?",
                                    option1: "1/4 cup",
                                    option2: "1/3 cup",
                                    option3: "1/2 cup",
                                    option4: "2/3 cup",
                                ...
                                {
                                    question: "If a bicycle wheel has a \nradius of 14 inches, what is its circumference (in inches)?",
                                    option1: "14π inches",
                                    option2: "28 inches",
                                    option3: "44 inches",
                                    option4: "88 inches",
                                ...
                                {
                                    question: "What is the next number in \nthe sequence: 1, 4, 9, 16, ...?",
                                    option1: "20",
                                    option2: "24",
                                    option3: "25",
                                    option4: "36",
                                ...
                                {
                                    question: "If a box contains 12 red balls \nand 8 blue balls, what is the probability of drawing a red ball randomly?",
                                    option1: "1/2",
                                    option2: "3/4",
                                    option3: "2/5",
                                    option4: "5/8",
                                ...
                                {
                                    question: "If a shirt costs $25 after a 20% \ndiscount, what was its original price?",
                                    option1: "$30",
                                    option2: "$35",
                                    option3: "$40",
                                    option4: "$50",
                                ...
                                {
                                    question: "If the area of a rectangle is 48 \nsquare meters and its length is \n12 meters, what is its width?",
                                    option1: "2 meters",
                                    option2: "4 meters",
                                    option3: "6 meters",
                                    option4: "8 meters",
                                ...
                                {
                                    question: "If a train travels at a speed \nof 60 miles per hour, how \nfar will it travel in 2.5 hours?",
                                    option1: "125 miles",
                                    option2: "150 miles",
                                    option3: "175 miles",
                                    option4: "200 miles",
                                ...
                                {
                                    question: "If 3 pencils cost $0.45, how much \ndo 9 pencils cost?",
                                    option1: "$1.15",
                                    option2: "$1.35",
                                    option3: "$1.45",
                                    option4: "$1.55",
                                ...
                                {
                                    question: "If the average of three numbers is \n15, and two of the numbers are \n10 and 20, what is the third number?",
                                    option1: "5",
                                    option2: "10",
                                    option3: "15",
                                    option4: "30",
                                ...
                                {
                                    question: "If it takes 8 hours to paint a house, and 4 \nhours to paint the same house with help, how long will it take the helper to paint the house alone?",
                                    option1: "4 hours",
                                    option2: "6 hours",
                                    option3: "8 hours",
                                    option4: "12 hours",
                            ...
                            {
                                    question: "If a car travels at a speed of 60 miles per \nhour, how far will it travel in 2 hours?",
                                    option1: "90 miles",
                                    option2: "120 miles",
                                    option3: "150 miles",
                                    option4: "180 miles",
                                ...
                                {
                                    question: "What is the next number in the \nsequence: 2, 4, 8, 16, ...?",
                                    option1: "24",
                                    option2: "32",
                                    option3: "48",
                                    option4: "64",
                ...
                Button {
                    ...
                    onClicked: {
                        ...
                        if (currentQuestionIndex < selectedQuestions.length) {
                            ...
                            // Quiz is complete
                            stackView.push("qrc:/technical/scoreCEasy.qml", { "score": score, "elapsedTime": elapsedTime, "userResponses": userResponses });
                        }
                    }
