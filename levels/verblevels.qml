...
import QtQuick.Controls 2.12
    ...
    Rectangle {
        ...
        Column {
            ...
            Button {
                onClicked: {
                    stackView.push("qrc:/verbal/verbeasy.qml") // Replace with the actual page for "C" questions
                    console.log("V easy clicked")
                }
                text: "Easy"
                width: 100
                height: 40
            ...
            Button {
                onClicked: {
                    stackView.push("qrc:/verbal/verbmedium.qml") // Replace with the actual page for "C" questions
                    console.log("V medium clicked")
                }
                text: "Medium"
                width: 100
                height: 40
            ...
            Button {
                onClicked: {
                    stackView.push("qrc:/verbal/verbhard.qml") // Replace with the actual page for "C" questions
                    console.log("V hard clicked")
                }
                text: "Hard"
                width: 100
                height: 40
